...
// 			template <typename T> static inline typename T::value_type Max(const T &data)
// 			{
...
// 			template <typename T> static inline typename T::value_type Min(const T &data)
// 			{
...
// 			template <typename T> static inline int Count(const T &data, std::function<bool(typename T::value_type value)> predicate)
// 			{
...
// 			template <typename T> static inline int ZeroCount(const std::vector<T> &data)
// 			{
// 				return std::count_if(
// 					data.begin(), data.end(),
// 					[](auto v) { return !v; }
...
// 			template <typename T> static inline bool IsBlank(const T &data, const typename T::value_type reference = 0)
// 			{
// 				return !std::any_of(
// 					data.begin(), data.end(),
...
// 			template<typename T> static void OR(T &result, const T &modifier)
// 			{
...
// 			template<typename T> static void AND(T &result, const T &modifier)
// 			{
// 				const size_t size = result.size();
